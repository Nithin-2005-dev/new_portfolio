...
<div className='flex flex-col items-center'>
  ...
  <p className='text-lg font-semibold'>Are you sure to disconnect with Nithin?</p>
  <div className='flex justify-between p-1 m-1 font-bold'><button className='bg-indigo-300 rounded-xl p-2 hover:scale-110' onClick={()=>{
    disconnect()
  }}>Yes I'm sure</button><button className='bg-indigo-300 rounded-xl p-2 hover:scale-110' onClick={()=>{
    setPop(false)
  }}>Not sure</button></div>
</div>}
