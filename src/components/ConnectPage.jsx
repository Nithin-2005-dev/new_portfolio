  ...
  return (
    <div className={`text-neutral-300 flex flex-col w-1/2 py-4 font-serif px-3`}  onMouseOver={()=>{
      ...
      >
        ...
        <input type="text" name="email" placeholder='enter your proffesion here'  className='my-3 px-2 text-orange-950 text-xl p-2 bg-slate-200 shadow-md drop-shadow-xl shadow-slate-400 rounded-lg' ref={proffesionRef}/>
        <label htmlFor="message">Any message to me</label>
        <textarea type="text" name="message" placeholder='enter your message(optional)'  className='my-3 px-2 text-orange-950 text-xl p-2 bg-slate-200 shadow-md drop-shadow-xl shadow-slate-400 rounded-lg' ref={messageRef}/>
