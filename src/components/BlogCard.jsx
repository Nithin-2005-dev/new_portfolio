...
const BlogCard = ({blog}) => {
  return (
    <motion.div initial={{x:-5}} whileInView={{x:0,transition:{
      ...
      amount:0.6
    }} className={`text-white flex flex-col text-center w-3/4 md:w-1/2 blog-card m-4`}>
      ...
      amount:0.5
        ...
        className='text-start font-serif italic text-lg text-gray-300 p-2 font-base' >{blog.body}</motion.p>
