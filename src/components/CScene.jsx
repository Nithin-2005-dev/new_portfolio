...
export default function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/compressed (2).glb')
  ...
  return (
    <group ref={group} {...props} dispose={null} rotation={[0,0,0]} position={[0,-1,0]} scale={1}>
      <group name="Sketchfab_Scene">
        ...
        <mesh
          ...
          position={[0.093, 0.151, 0.318]}
          scale={[0.86, 0.779, 0.744]}
        />
        <mesh
...
useGLTF.preload('/compressed (2).glb')
